...
button.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Màu nền của nút

-- Tạo Gradient cho màu nền
local gradient = Instance.new("UIGradient")
gradient.Rotation = 90
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(211, 211, 211)), -- Màu xám nhạt
    ColorSequenceKeypoint.new(1, Color3.fromRGB(211, 211, 211)), -- Màu xám nhạt (giống với màu ở vị trí 0)
}
gradient.Parent = button -- Đặt Gradient là con của nút

-- Văn bản trên nút
button.Text = "Stop tweening"
...
-- Định nghĩa hàm reset
local function resetFunction()
    -- Thực hiện hành động để reset trạng thái ban đầu
    print("Resetting...")
end

-- Định nghĩa hàm callback
local function myCallback()
    -- Thử thực hiện một hành động có thể gây lỗi
    ...
    if not success then
        -- Nếu có lỗi, in ra thông báo lỗi và thực hiện reset
        warn("Callback function encountered an error:", errorMessage)
        -- Thực hiện hành động reset
        resetFunction()
    else
        -- Nếu không có lỗi, tiếp tục thực hiện hành động tiếp theo
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>This Hub Is Made By Idk Team 😁 <Color=/>"):Display()
end)

local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/nhanhackerlord/ssave/main/save"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/nhanhackerlord/idk-folder/main/idk"))()
loadstring(game:HttpGet("https://raw.githubusercontent.com/nhanhackerlord/Ver/main/ver"))()
local Window = Fluent:CreateWindow({
    Title = "IDK Hub ".._G.Version,
    SubTitle = " - By Discord: buiphamducnhan!",
    TabWidth = 80,
...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "V4 Race Trials", Icon = "" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "" }),
	Misc = Window:AddTab({ Title = "Other", Icon = "" }),
    Setting = Window:AddTab({ Title = "Setting Menu", Icon = "" }),
}
...
player.OnTeleport:Connect(function(state)
    if state == Enum.TeleportState.Started then
        -- Yêu cầu quay lại trò chơi khi bị kick
        local success, errorMessage = pcall(function()
            game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, player)
        end)
        if not success then
            warn("Failed to teleport back to game:", errorMessage)
        end
    end
end)
...
ImageButton.Image = "rbxassetid://95257916640360"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack','Extra Fast Attack'}

    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Choose speed attack",
        Description = "",
...
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    Title = "Auto chest [Stop when got an item] [Instance mode]",
    Description = "", 
    Default = false })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Choose type of Mastery Farm",
        Description = "",
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {
        Title = "Auto mastery Devil Fruit",
        Description = "", 
        Default = false })
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {
        Title = "Auto farm choosed material",
        Description = "", 
        Default = false })
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "TP To Kítune Island",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Auto Attack Pirate Ship",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Attack Ship",Description = "",Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Auto Elite Boss")

    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Elite Boss",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Auto AFK to Sea Beast Farm",Description = "", Default = false })
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    local AutoMysticIsland = Tabs.Main:AddSection("Mirrage Island")


    Tabs.Main:AddButton({
        Title = "TP To Mirage Island",
        Description = "",
        Callback = function()
            TweenMirage()
        end
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Auto claim gear",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Auto look moon and claim gear",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "AFK For Mirage Island",Description = "", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Fully Hallow Sycthe",Description = "", Default = false })
	...
	spawn(function()
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Auto Touch for Tushita",Description = "", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Auto Kill Katakuri ",Description = "", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Auto buy Haki colour",Description = "",Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Auto Legendary Sword",Description = "",Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Auto get race V2",Description = "",Default = false })
...
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Stats Meele",Description = "", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Stats Sword",Description = "", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Stats Sword",Description = "", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Stats Gun", Description = "",Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Stats Devil Fruit",Description = "", Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Fly To Player", Description = "",Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Look Up Player",Description = "", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = "Auto Attack player",Description = "", Default = false })

ToggleFastAttack:OnChanged(function(Value)
 _G.FastAttackGamer144YTB = Value
end)
...
while wait() do
    pcall(function()
        if _G.FastAttackGamer144YTB then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackGamer144YTB
        end
    end)
end
end)
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "AimSkill Like RedzHub",Description = "", Default = false })
...
local Mastery = Tabs.Player:AddSection("Other")


local ToggleNoClip = Tabs.Player:AddToggle("ToggleNoClip", {Title = "Walk Through Wall",Description = "", Default = false })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Speed run Hack",Description = "", Default = true })
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "Demon Mode", Description = "",Default = false })
...
local Teleport = Tabs.Teleport:AddSection("TP World")
...
local Mastery = Tabs.Teleport:AddSection("TP Island")
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Claim Fruit",Description = "", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Auto join raid",Description = "", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Auto Next Island",Description = "", Default = true })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awk",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Auto Get Fruit Under 1m",Description = "", Default = false })
...
Tabs.Visual:AddButton({
    ...
    Description = "",
    Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://95257916640360")[1]:GetChildren()) do
...
Tabs.Visual:AddButton({
    ...
    Description = "Fake Level, Beli and EXP",
    Callback = function()
...
Tabs.Visual:AddInput("Input_Fragments", {
    ...
    local Toggle = Tabs.St:AddToggle("MyToggle", {Title = "Auto Join Job ID", Default = false })
...
local LockMoonToggle = Tabs.Race:AddToggle("LockMoon_Toggle", {Title = "Auto lock moon", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Complete Ghoul/Human Race ",Description = "", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Complete Trials",Description = "", Default = false })
...
local Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Kill Player When Trial Complete", Default = false })
...
local Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Kill Player When Trial Done", Default = false })
...
local Mastery = Tabs.Shop:AddSection("Other Items")
...
Tabs.Misc:AddButton({
	...
	Callback = function()
		...
		local cac = { "Super human", "Electric Claw", "Dragon Talon", "Sharkman Karate", "Death Step", "God Human" }
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				local huhu = Instance.new("ImageLabel", MeleeG)
				huhu.Image = "rbxassetid://95257916640360"
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Instance TP",Description = "", Default = true })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remove damage text",Description = "", Default = false })
...
local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Super Fast Click", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Clear all Notification",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "Ưhite screen (FPS Boost)",Description = "", Default = false })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Z move",Description = "", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "X move", Description = "",Default = true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "C move",Description = "", Default = true })
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "V move",Description = "", Default = true })
...
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "F move",Description = "", Default = false })
...
local Pos = Tabs.Setting:AddSection("Farm Distance")
